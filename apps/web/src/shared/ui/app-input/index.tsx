...
export default function AppInput({ label, error, className, ...rest }: AppInputProps) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        {...rest}
        className={`rounded-[6px] border border-[#d1d5db] bg-white px-[17px] py-[11px] text-[16px] text-[#1f2937] outline-none transition-colors placeholder:text-[#9ca3af] focus:border-app-accent-blue ${className ?? ""}`}
      />
