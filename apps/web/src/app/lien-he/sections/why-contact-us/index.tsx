...
function TruckIcon() {
  return (
    <svg width="25" height="20" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
      <path
...
function FactoryIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
...
export default function WhyContactUsSection() {
  return (
    <section
      ...
      className="border-t border-[#f3f4f6] bg-white px-14 pb-16 pt-[65px] max-lg:px-8"
    >
      <div className="mx-auto max-w-[1216px]">
        <div className="flex gap-6 max-lg:flex-col">
          {whyContactUsContent.cards.map((card, i) => (
            <AppScrollReveal key={card.icon} variant="fade-in-up" delayMs={i * 100} className="flex flex-1">
              <div
                className={clsx(
              ...
              >
                ...
                <h4 className="pt-[9px] text-center text-base font-bold leading-6 text-[#333]">{card.title}</h4>
                <p className="text-center text-sm leading-[22.75px] text-[#6b7280]">
