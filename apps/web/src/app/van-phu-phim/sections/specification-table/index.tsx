...
export default function SpecificationTableSection() {
  ...
  return (
    <section className={clsx("flex flex-col items-start bg-[#f9fafb] py-20 max-md:py-12")}>
      <div className={clsx("mx-auto flex w-full max-w-7xl flex-col items-start gap-14 px-8", "max-md:px-4")}>
        <div className={clsx("flex w-full flex-col items-center gap-4")}>
          ...
          <h2
            className={clsx(
              "w-full text-center text-4xl font-black uppercase leading-10 text-[#333]",
          ...
          <p className={clsx("w-full max-w-[576px] text-center text-sm font-normal leading-5", "text-gray-500")}>
        ...
        >
          <div className={clsx("flex w-full items-center gap-4 bg-[#2973b2] px-8 py-5")}>
            <IconGrid className={clsx("size-5 shrink-0 text-white")} />
            <h3 className={clsx("text-lg font-bold uppercase leading-7 tracking-[0.45px] text-white")}>
          ...
          <div
            className={clsx(
              "flex w-full items-center justify-between border-t border-gray-200 px-8",
              "py-[19px] max-md:flex-col max-md:gap-3 max-md:px-4"
            )}
          >
            <div className={clsx("flex items-center gap-2")}>
              <IconInfo className={clsx("size-3 shrink-0")} />
              <span className={clsx("text-xs font-normal leading-4 text-gray-500")}>
                {specTableContent.footer.text}
              </span>
            </div>
            <a
              href="#"
              className={clsx(
                "flex h-auto items-center gap-2 bg-transparent px-0 text-sm font-semibold",
