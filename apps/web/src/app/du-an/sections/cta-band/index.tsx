...
export default function CtaBandSection() {
  return (
    <div
      className={clsx(
        "flex flex-col items-start border-b border-gray-100 bg-white px-[272px]",
        "pb-[65px] pt-16 max-lg:px-8"
      )}
    >
      <div className={clsx("mx-auto flex w-full max-w-[896px] flex-col items-center gap-5 px-8")}>
        <div
          className={clsx(
        ...
        <h2
          className={clsx(
            "w-full text-center text-4xl font-extrabold uppercase leading-10",
        ...
        <p className={clsx("w-full max-w-[576px] text-center text-base font-normal leading-[26px]", "text-gray-500")}>
        ...
        <div className={clsx("flex w-full items-start justify-center gap-4 pt-3 max-md:flex-col")}>
          <a
            ...
            className={clsx(
              "flex shrink-0 items-center justify-center gap-2 rounded-lg border-2",
              "border-[#2973b2] bg-[#2973b2] px-8 py-4 text-base font-bold uppercase",
              "leading-6 tracking-[0.4px] text-white",
          ...
          <a
            ...
            className={clsx(
              "flex shrink-0 items-center justify-center gap-2 rounded-lg border-2",
              "border-[#2973b2] px-[34px] py-4 text-base font-bold uppercase leading-6",
              "tracking-[0.4px] text-[#2973b2]"
            )}
          >
            <span className={clsx("inline-flex py-1")}>
