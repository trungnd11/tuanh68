...
export default function ProjectGridSection() {
  ...
  return (
    <section className={clsx("flex flex-col items-start bg-[#f8f9fa] px-20 py-16 max-lg:px-8", "max-md:py-12")}>
      <div className={clsx("mx-auto flex w-full max-w-7xl flex-col items-start gap-12 px-8")}>
        <div className={clsx("grid w-full grid-cols-3 gap-6")}>
          {layout.map((item, i) => {
                ...
                <div className={clsx("absolute bottom-0 left-0 right-0 p-6")}>
                  <h3
                    className={clsx(
                      ...
                      item.colSpan === "col-span-2" ? "text-xl leading-7" : "text-base leading-6"
                    )}
                  >
                    {project.name}
                  </h3>
                  <p className={clsx("text-sm font-normal leading-5 text-gray-300")}>
                    {project.location}
                ...
                >
                  <div className={clsx("mb-3 flex items-center gap-2")}>
                    ...
                    {project.category && (
                      <span
                        className={clsx(
                          "rounded-full bg-white/20 px-3 py-1 text-xs font-semibold leading-4",
                          "text-white"
                        )}
                      >
                        {project.category}
                  ...
                  <h3
                    className={clsx(
                      ...
                      item.colSpan === "col-span-2" ? "text-2xl leading-8" : "text-lg leading-7"
                    )}
                  >
                    {project.nameUpper}
                  </h3>
                  ...
                  <div className={clsx("mt-1 flex items-center gap-4")}>
                    {project.location && (
                      <span className={clsx("flex items-center gap-1 text-sm font-normal leading-5 text-[#bfdbfe]")}>
        ...
        <div className={clsx("flex w-full items-center justify-center pt-4")}>
          <button
            className={clsx(
