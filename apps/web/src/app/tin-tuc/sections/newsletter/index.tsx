...
export default function NewsletterSection() {
  return (
    <section className="border-t border-[#1f2937] bg-[#111827] px-5 py-16 sm:px-8 lg:px-28 lg:pb-16 lg:pt-[65px]">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center gap-10 lg:flex-row lg:items-center">
        <AppScrollReveal variant="fade-in-up" className="flex flex-1 flex-col gap-3">
          ...
          <h2 className="pt-1 text-[30px] font-black uppercase leading-[36px] text-white">
            {newsletterContent.titleBefore}
            <span className="text-app-brand-teal">{newsletterContent.titleAccent}</span>
            {newsletterContent.titleAfter}
          </h2>

          <p className="max-w-[448px] text-[14px] leading-[22.75px] text-[#9ca3af]">
        ...
        <AppScrollReveal variant="fade-in-up" delayMs={100} className="flex w-full flex-1 items-start gap-3 lg:w-auto">
          <div className="flex-1 rounded-[8px] border border-[#374151] bg-[#1f2937] px-[21px] py-[18px]">
            <input
              type="email"
              placeholder={newsletterContent.inputPlaceholder}
              className="w-full bg-transparent text-[14px] text-white outline-none placeholder:text-[#6b7280]"
            />
          </div>
          <button className="flex items-center gap-2 rounded-[8px] bg-app-brand-teal px-7 py-[16.5px] text-[14px] font-bold uppercase tracking-[0.35px] text-white transition-opacity hover:opacity-90">
